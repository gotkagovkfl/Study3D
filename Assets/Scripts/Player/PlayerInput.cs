...
namespace Study3D
{
    public class PlayerInput : MonoBehaviour 
    {
        ...
        private void Update() 
        {
            ...
            // 마우스 움직임에 관한 입력 감지
            float mouseMoveH = Input.GetAxis(mouseHorizontalAxisName);
            float mouseMoveV = Input.GetAxis(mouseVerticalAxisName);
            mouseMoveVector = new Vector2(mouseMoveH,mouseMoveV);
